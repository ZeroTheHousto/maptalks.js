describe('TileLayer', function () {
  ...
  describe('add to map', function () {
    ...
    it('set tile size', function () {
      createMap()
      const tile1 = new maptalks.TileLayer('tile', {
        renderer: 'canvas',
        urlTemplate: '#',
        tileSize: [1, 2]
      })
      ...
      const tile2 = new maptalks.TileLayer('tile', {
        renderer: 'canvas',
        urlTemplate: '#',
    ...
    it('tiles out of extent', function () {
      createMap()
      const p = map.getProjection().project(map.getCenter())
