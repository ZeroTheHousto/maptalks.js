describe('Geometry.Polygon', function () {
  ...
  it('getCenter', function () {
    ...
    const polygon = new maptalks.Polygon(rings)
    const got = polygon.getCenter()
  ...
  it('get center in extent', function () {
    ...
    const polygon = new maptalks.Polygon(rings)
    const got = polygon.getCenterInExtent(new maptalks.Extent(0, 0, 0.5, 0.5))
  ...
  it('getCoordinates', function () {
    ...
    const polygon = new maptalks.Polygon([rings, holes])
  ...
  describe('creation', function () {
    it('normal constructor', function () {
      ...
      const polygon = new maptalks.Polygon(points)
  ...
  describe('geometry fires events', function () {
    it('canvas events', function () {
      ...
      const vector = new maptalks.Polygon(points)
  ...
  describe('smoothness', function () {
    it('draw 3 points with smoothness', function () {
      ...
      const line = new maptalks.Polygon([
        center.sub(0.001, 0),
        center.add(0.001, 0),
