describe('#Point', function () {
  describe('has various constructors', function () {
    it('can be created by an array', function () {
      const c = new maptalks.Point([0, 0])
    ...
    it('can be created by a object with x,y', function () {
      const c = new maptalks.Point({ x: 0, y: 0 })
      expect(c.x).to.be.eql(0)
      expect(c.y).to.be.eql(0)
    })

    it('can be created by another Point', function () {
      const c = new maptalks.Point(new maptalks.Point(0, 0))
      expect(c.x).to.be.eql(0)
      expect(c.y).to.be.eql(0)
    })
  ...
  describe('has operations', function () {
    it('can add', function () {
      const c = new maptalks.Point(new maptalks.Point(0, 0))
      const t = c.add(new maptalks.Point(1, 1))
      expect(c.x).to.be.eql(0)
      expect(c.y).to.be.eql(0)
    ...
    it('can _add which is destructive', function () {
      const c = new maptalks.Point(new maptalks.Point(0, 0))
      const t = c._add(new maptalks.Point(1, 1))
    ...
    it('can substract', function () {
      const c = new maptalks.Point(new maptalks.Point(0, 0))
      const t = c.substract(new maptalks.Point(1, 1))
      expect(c.x).to.be.eql(0)
      expect(c.y).to.be.eql(0)
      expect(t.x).to.be.eql(-1)
      expect(t.y).to.be.eql(-1)
    ...
    it('can _substract which is destructive', function () {
      const c = new maptalks.Point(new maptalks.Point(0, 0))
      const t = c._substract(new maptalks.Point(1, 1))
      expect(c.x).to.be.eql(-1)
      expect(c.y).to.be.eql(-1)
      expect(t.x).to.be.eql(-1)
      expect(t.y).to.be.eql(-1)
    ...
    it('can _multi which is destructive', function () {
      const c = new maptalks.Point(new maptalks.Point(2, 3))
      const t = c._multi(3)
    ...
    it('can decide whether is equal', function () {
      const c1 = new maptalks.Point(new maptalks.Point(2, 3))
      const c2 = new maptalks.Point(new maptalks.Point(2, 3))
    ...
    it('can _ceil', function () {
      const c = new maptalks.Point(new maptalks.Point(2.1, 3.1))
      const t = c._ceil()
    ...
    it('can toJSON', function () {
      const c = new maptalks.Point(-2, -3)
      const t = c.toJSON()
      expect(t).to.be.eql({
        x: -2,
        y: -3
    ...
    it('can toArray', function () {
      const c1 = new maptalks.Point(2, 3)
