...
const Eventable = base => {
   ...
   */
  const on = (eventsOn, handler, context) => {
    if (!eventsOn) {
      return this
    }
  ...
  /**
       ...
       */
  const addEventListener = (eventTypes, handler, context = null) => {
    this.on.apply(this, { eventTypes, handler, context })
  }
  ...
  /**
       ...
       */
  const once = (eventTypes, handler, context) => {
  ...
  /**
       ...
       */
  const off = (eventsOff, handler, context) => {
  ...
  /**
       ...
       */
  const listens = (eventType, handler, context) => {
  ...
  /**
       ...
       */
  const copyEventListeners = (target) => {
  ...
  const _wrapOnceHandler = (evtType, handler, context) => {
    const me = this
  ...
  const _switch = (to, eventKeys, context) => {
  ...
  const _clearListeners = (eventType) => {
    if (!this._eventMap || !isString(eventType)) {
      return
    }
    const handlerChain = this._eventMap[eventType.toLowerCase()]
  ...
  const _clearAllListeners = () => { this._eventMap = null }
  ...
  /**
       ...
       */
  const _setEventParent = (parent) => {
    this._eventParent = parent
    return this
  }

  const _fire = (eventType, param) => {
    if (!this._eventMap) {
      return this
    }
    const handlerChain = this._eventMap[eventType.toLowerCase()]
  ...
  return {
    ...base, on, addEventListener, once, off, removeEventListener, listens, getListeningEvents, copyEventListeners, fire, _wrapOnceHandler, _switch, _clearListeners, _clearAllListeners, _setEventParent, _fire
  }
}
