...
const TextEditable = {
  ...
  _createEditor () {
    ...
    const textColor = symbol.textFill || '#000000'
    const textSize = symbol.textSize || 12
    const height = labelSize.height
    const lineColor = symbol.markerLineColor || '#000'
    const fill = symbol.markerFill || '#3398CC'
    const spacing = symbol.textLineSpacing || 0
