...
class MapCanvasRenderer extends MapRenderer {
  ...
  drawLayerCanvas (layers) {
    ...
    const limit = map.options.layerCanvasLimitOnInteracting
  ...
  initContainer () {
    ...
    const mapAllLayers = createContainer('allLayers', 'maptalks-all-layers', POSITION0 + 'padding:0px;margin:0px;z-index:0;overflow:visible;', true)
    const backStatic = createContainer('backStatic', 'maptalks-back-static', POSITION0 + 'z-index:0;', true)
    const back = createContainer('back', 'maptalks-back', POSITION0 + 'z-index:1;')
    const backLayer = createContainer('backLayer', 'maptalks-back-layer', POSITION0)
    const canvasContainer = createContainer('canvasContainer', 'maptalks-canvas-layer', POSITION0 + 'border:none;z-index:2;')
    const frontStatic = createContainer('frontStatic', 'maptalks-front-static', POSITION0 + 'z-index:3;', true)
    const front = createContainer('front', 'maptalks-front', POSITION0 + 'z-index:4;', true)
    const frontLayer = createContainer('frontLayer', 'maptalks-front-layer', POSITION0 + 'z-index:0;')
    ...
    const ui = createContainer('ui', 'maptalks-ui', POSITION0 + 'border:none;z-index:1;', true)
    const control = createContainer('control', 'maptalks-control', 'z-index:1', true)
  ...
  _drawLayerCanvasImage (layer, layerImage) {
    ...
    const width = canvasImage.width; const height = canvasImage.height
